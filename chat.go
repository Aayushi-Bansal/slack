...
func (sl *Slack) ChatPostMessage(channelId string, threadTs string, brodcast string, text string, opt *ChatPostMessageOpt) (*ChatPostMessageAPIResponse, error) {
	...
	if threadTs != "" {
		...
		uv.Add("reply_broadcast", brodcast)
	}
